...
if __name__ == '__main__':
    ...
    for j in range(0, nc):
        ...
        print(X.shape)
        if train:
            # name = 'F:/LargeDataFile/CUB_200_2011/CUB200_ViT/train_aug_ViT-B32_224_ImageNetNorm/%s.mat' % (names[j])
            name = 'F:/LargeDataFile/CUB_200_2011/CUB200_ViT/train_aug_ViT-L14_224_ImageNetNorm/%s.mat' % (names[j])
